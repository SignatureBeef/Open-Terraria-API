...
namespace OTAPI.Core.Tests
{
    class Program
    {
        ...
        static void AttachHooks()
        {
            ...
            //    return HookResult.Continue;
            //};
            Hooks.Net.Player.PreGreet = (ref int playerId) =>
            {
                Console.WriteLine(nameof(Hooks.Net.Player.PreGreet) + " " + playerId);
                return HookResult.Continue;
            };
            Hooks.Net.Player.PostGreet = (int playerId) =>
            {
                Console.WriteLine(nameof(Hooks.Net.Player.PostGreet) + " " + playerId);
            };
            //Hooks.Net.SendBytes = (
            //    ref int remoteClient,
            //    ref byte[] data,
