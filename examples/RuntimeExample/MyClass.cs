...
namespace RuntimeExample
{
    public static class Hooks
    {
        ...
        {
            Console.WriteLine("[RuntimeExample] Hello World! from a compiled DLL");
