...
namespace OTA.Logging
{
    ...
    /// <summary>
    /// ProgressLogger allows you to display a progress bar in the console without disrupting other logging actions.
    /// </summary>
    /// <example>
    /// using (var pg = new ProgressLogger(100, "Test progress bar!"))
    /// {
    ///     for (var x = 0; x < pg.Max; x += 10)
    ///     {
