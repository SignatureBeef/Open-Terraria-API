...
namespace OTA.Callbacks
{
    public static class WorldFileCallback
    {
        ...
        {
#if MemTile
            OTA.Memory.MemTile.Prepare(Terraria.Main.maxTilesX, Terraria.Main.maxTilesY);
#elif VANILLACOMPAT
            //System.Console.WriteLine("TTile definition size: " + (System.Runtime.InteropServices.Marshal.SizeOf(typeof(Terraria.Tile))));
