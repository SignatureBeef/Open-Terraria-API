...
namespace OTAPI.Patcher.Targets
{
    ...
    public class TMLPCServerTarget : IPatchTarget
    {
        public virtual string DisplayText { get; } = "TML PC Server";
...
");
        ...
        {
            return Directory.EnumerateFiles(extractedFolder, "tModLoaderServer.exe", SearchOption.AllDirectories).Single();
        }

        public virtual string GetZipUrl()
        {
            // TODO aquire from github but likely will break anyway (with 1.4 on its way...)
