# Open Terraria API [![Build Status](https://travis-ci.org/DeathCradle/Open-Terraria-API.svg?branch=MonoMod)](https://travis-ci.org/DeathCradle/Open-Terraria-API?branch=MonoMod)
