# Open Terraria API [![Build Status](https://travis-ci.org/DeathCradle/Open-Terraria-API.svg?branch=upcoming)](https://travis-ci.org/DeathCradle/Open-Terraria-API?branch=upcoming)
