...
namespace OTAPI.Modifications.StatusText.Modifications
{
    ...
    public class DedServModification : ModificationBase
    {
        ...
        public override void Run()
        {
            ...
            //and modify it's IL
            var mthDedServ = this.SourceDefinition.Type("Terraria.Main").Method("DedServ");
            ...
            //check).
            var fldOldStatusText = this.SourceDefinition.Type("Terraria.Main").Field("oldStatusText");
